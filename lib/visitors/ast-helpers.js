...
export type Node = Identifier | MemberExpression | CallExpression | ArrayExpression
type Identifier = {type: 'Identifier', name: string}
type MemberExpression = {type: 'MemberExpression', object: Node, property: Node}
type CallExpression = {type: 'CallExpression', callee: Node, arguments: Node[]}
type ArrayExpression = {type: 'ArrayExpression', elements: Node[]}
